                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.products.update', $product->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    <label>Preview</label>
                                    <div>
                                        <img src="{{ asset($product->thumbnail) }}" alt="" width="200">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Detail</label>
                                    <textarea name="details" class="form-control summernote">{{ $product->details }}</textarea>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputState">Top Product</label>
                                            <select id="inputState" class="form-control" name="is_top">
                                                <option value="">Select</option>
                                                <option {{ $product->is_top == 0 ? 'selected' : '' }} value="0">Yes
                                                </option>
                                                <option {{ $product->is_top == 1 ? 'selected' : '' }} value="1">No
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="inputState">Best Product</label>
                                            <select id="inputState" class="form-control" name="is_best">
                                                <option value="">Select</option>
                                                <option {{ $product->is_best == 0 ? 'selected' : '' }} value="0">Yes
                                                </option>
                                                <option {{ $product->is_best == 1 ? 'selected' : '' }} value="1">No
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select id="inputState" class="form-control" name="is_featured">
                                                <option value="">Select</option>
                                                <option {{ $product->is_featured == 0 ? 'selected' : '' }} value="0">
                                                    Yes</option>
                                                <option {{ $product->is_featured == 1 ? 'selected' : '' }} value="1">
                                                    No</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="inputState" class="form-control" name="status">
                                        <option {{ $product->status == 0 ? 'selected' : '' }} value="0">Active
                                        </option>
                                        <option {{ $product->status == 1 ? 'selected' : '' }} value="1">Inactive
                                        </option>
                                    </select>
                                </div>
